	...
	<script type="text/javascript">
		...
		function fncAddUser() {
			...
			if( pw != pw_confirm ) {				
				...
				$("span.col-password-check").html("비밀번호 확인이 일치하지 않습니다.").css("color","red");
			 ...
			 $("input[name='userId']").on("keyup" , function() {
				...
				$.ajax({
					...
					success : function(JSONData, status){
						...
						if( JSONData == true){
							$("span.col-id-check").html("사용가능한 아이디입니다.").css("color","blue");
						}else{
							$("span.col-id-check").html("사용 불가능한 아이디입니다.").css("color","red");
						}
