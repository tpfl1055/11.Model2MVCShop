...
CREATE SEQUENCE seq_opinion_op_no	     INCREMENT BY 1 START WITH 1;
...
CREATE TABLE opinion ( 
	op_no								  NUMBER,
	op_prod_no 						   NUMBER, 				
	op_prod_name 				      VARCHAR2(100), 	
	opinion 						      VARCHAR2(200),
	op_image_file 					 VARCHAR2(100),
	op_reg_date 					 DATE,
	PRIMARY KEY(op_no)
);

	ALTER TABLE opinion ADD op_user_id VARCHAR2(20) DEFAULT NULL;
